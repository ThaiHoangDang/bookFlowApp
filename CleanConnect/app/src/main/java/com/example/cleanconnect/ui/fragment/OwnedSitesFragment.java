...
import com.example.cleanconnect.databinding.FragmentOwnedSitesBinding;
...
public class OwnedSitesFragment extends Fragment implements ClickCallBack {
    private FragmentOwnedSitesBinding bind;
    private OwnedSitesViewModel viewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bind = FragmentOwnedSitesBinding.inflate(inflater, container, false);
        viewModel = new ViewModelProvider(requireActivity()).get(OwnedSitesViewModel.class);
    ...
    private void initSiteView() {
        ...
        bind.addButton.setOnClickListener(v -> {
            activity.navController.navigate(R.id.createSiteFragment);
        });
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(requireActivity(), new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                adapter = new SiteHorizontalAdapter(OwnedSitesFragment.this, userLocation);
