...
import com.example.cleanconnect.databinding.FragmentAllSitesBinding;
...
public class AllSitesFragment extends Fragment implements ClickCallBack {
    private FragmentAllSitesBinding bind;
    private AllSitesViewModel viewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bind = FragmentAllSitesBinding.inflate(inflater, container, false);
        viewModel = new ViewModelProvider(requireActivity()).get(AllSitesViewModel.class);
        initSiteView();
        return bind.getRoot();
    }
    ...
    private void initSiteView() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(requireActivity(), new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                adapter = new SiteHorizontalAdapter(AllSitesFragment.this, userLocation);
